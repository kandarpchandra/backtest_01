...
from backtester.events.types import BarEvent, SignalEvent, SignalDirection, OrderEvent
...
def test_event_queue_priority():
    ...
    bar = BarEvent(timestamp=1.0, symbol="AAPL", open=100, high=101, low=99, close=100, volume=100)
